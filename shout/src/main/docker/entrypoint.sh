...
JAVA_OPTIONS=""
#JAVA_OPTIONS="-Xmx256m -Xss256k -XX:MaxMetaspaceSize=128m -XX:MaxDirectMemorySize=16m -XX:+UseCompressedOops"
...
exec java $JAVA_OPTIONS -jar /shout.jar $SPRING_OPTIONS "$@"